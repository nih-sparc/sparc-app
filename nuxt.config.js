export default {
   ...
   ** Global CSS
   */
    css: ['element-ui/lib/theme-chalk/index.css', '@fortawesome/fontawesome-svg-core/styles.css'],
  /*
   ** Plugins to load before mounting the App
   */
    plugins: ['@/plugins/bootstrap', '@/plugins/contentful', '~/plugins/fontawesome.js'],
  /*
   ** Nuxt.js dev-modules
   */
  buildModules: [
