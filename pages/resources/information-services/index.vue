...
export default {
  ...
  methods: {
    ...
    async onPaginationPageChange(page) {
      ...
      const response = await fetchResources('Information Services', this.$route.query.search, this.sortOrder, this.type, limit, offset)
    ...
    async onPaginationLimitChange(limit) {
      ...
      const response = await fetchResources('Information Services', this.$route.query.search, this.sortOrder, this.type, newLimit, 0)
      this.resources = response
    },
    async onSortOptionChange(option) {
      this.selectedSortOption = option
      const response = await fetchResources('Information Services', this.$route.query.search, this.sortOrder, this.type, this.resources.limit, 0)
      this.resources = response
    }
  }
}
