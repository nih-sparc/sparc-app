    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: 'description',
          name: 'description',
          content: this.entry.summary ? this.entry.summary : 'The open community platform for bridging the body and the brain through neuroscience and systems physiology data, computational and spatial modeling, and device design.'
        },
      ]
    }
  },
